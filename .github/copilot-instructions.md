...
- PostgreSQL 15+ test database (paytrust_test) (002-real-endpoint-testing)

- Rust 1.91.0+ (stable Nov 2025) with 2021 edition features (001-payment-orchestration-api)
- PostgreSQL 15+ with standard engine (001-payment-orchestration-api)
...
- sqlx 0.8.x - Async PostgreSQL driver with enhanced compile-time checking (001-payment-orchestration-api)
