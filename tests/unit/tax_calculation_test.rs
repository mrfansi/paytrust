...
fn calculate_invoice_total(subtotal: Decimal, tax_rate: Decimal, service_fee_percentage: Decimal, service_fee_fixed: Decimal) -> Decimal {
...
fn test_specific_calculation_examples() {
    ...
    assert_ne!(tax, incorrect_tax, "Tax should not include service fee in base");
    assert!(tax < incorrect_tax, "Correct tax should be less than incorrect calculation");
}
...
fn test_order_independence() {
    ...
    assert_eq!(tax_first, tax_second, "Tax should be same regardless of calculation order");
    assert_eq!(fee_first, fee_second, "Service fee should be same regardless of calculation order");
    assert_eq!(total_first, total_second, "Total should be same regardless of calculation order");
}
